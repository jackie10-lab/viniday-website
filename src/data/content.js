...
// Replace placeholder values with your own text, image paths, and dates.
// Images, videos, and music should be placed in the /public/ folders.
// ============================================================================
...
You deserve to be celebrated not just today, but every single day. Happy Birthday, beautiful.`
  },
  ...
  firstImpression: {
    ...
    image: "/images/first-impression.jpg",
    story: `I still remember the day time I saw you like it was yesterday. We were in Dubai, and I was trying to help you by giving you napkins or soft drinks even though someone else wanted it, but all I could see was you.

You had this cute little smile,and the way your eyes lit up. I knew right then that you were someone special. There was this warmth about you, this light that drew me in immediately.

I didn't know it yet, but that moment would change everything. That moment was the beginning of something beautiful.`,
    timeline: [
      {
      ...
      {
        date: "Our Matcha girl",
        title: "Kale Sobith",
        description: "One of the many little details that make you who you are — your love for matcha.",
      ...
      },
      {
        ...
        title: "I Knew You Were Special",
        description: "Walking with you at nights and trying your favorite foods was my favorite thing to do",
  ...
  memories: [
    ...
    },
    {
      ...
      date: "Cotton Candy",
      title: "Still not done with arcade",
    ...
    {
      image: "/images/untold1.jpg",
      date: "Let's goooo0",
      title: "No words",
      description: "Should be a model,the angel with no wings."
    },
    {
      image: "/images/mall4.jpg",
      date: "Tim Hortons Run",
      title: "Matcha Mode Activated",
      description: "you acting like this was a whole photoshoot 😂."
    },
    {
      image: "/images/arcade3.jpg",
      date: "Cute",
      title: "The Arcade Champion",
  ...
  gallery: [
    ...
    {
      image: "/images/m4.jpg",
      date: "Leave your matcha come to mine",
      title: "",
      description: "Add your own memory here."
    },
    {
    ...
    {
      image: "/images/c3.jpg",
      date: "7am after no sleep, still beautiful",
      title: "",
      description: "Add your own memory here."
    },
    {
    ...
    {
      image: "/images/s2.jpg",
      date: "the chinese guy haricut, give me his linkdein",
      title: "",
      description: "Add your own memory here."
    },
    {
    ...
    },
    {
      ...
      date: "No words, Should be kept in musuem",
      title: "",
      description: "Add your own memory here."
    },
    {
      image: "/images/cl4.jpg",
      date: "You mentioned today, that miss going out to malls with me hahaha",
      title: "",
      description: "Add your own memory here."
    },
    {
      image: "/images/cl3.jpg",
      date: "Maka zainna re, my cheeks are paining",
      title: "",
      description: "Add your own memory here."
    },
  ...
  admirationCards: [
    ...
    },
    {
      icon: "smile",
      title: "Your Smile",
      description: "Your smile has the power to brighten my darkest days. It's genuine, warm, and absolutely captivating. When you smile, the whole room feels it.",
    ...
    },
    {
      ...
      description: "The way you carry yourself with such grace and self-assurance inspires me every day. You know who you are, and you never apologize for it. That strength is beautiful.",
      image: "/images/con1.jpg"
    },
    {
      icon: "palette",
      title: "Your Creativity",
      description: "Your mind works in the most beautiful ways. The way you see the world, create art, solve problems, and express yourself — it's uniquely you and absolutely magical.",
      image: "/images/creativity.jpg"
    },
    {
      icon: "zap",
      title: "Your Determination",
      description: "When you set your mind to something, nothing can stop you. Your drive and passion for your dreams push me to be better. You don't just dream — you do.",
      image: "/images/det.jpg"
    },
    {
      icon: "sun",
      title: "Your Energy",
      description: "Being around you feels like standing in sunlight. Your energy is infectious, uplifting, and warm. You bring life to every room you enter.",
  ...
  openWhenCards: [
    {
      ...
      icon: "smile",
      quote: "Happiness is only real when shared. I'm so glad I can make you smile.",
      message: `Your happiness is contagious! When you're feeling good, the whole world seems brighter.

I hope this moment lasts forever. Remember this feeling — you deserve every ounce of joy that comes your way.
...
I believe in you. Always.`,
    ...
    {
      id: "missfriends",
      title: "Open When You Miss Your Friends",
      subtitle: "Friendship never ends",
      icon: "users",
      quote: "Good friends are like stars. You don't always see them, but you know they're always there.",
      message: `Distance doesn't diminish true friendship. The bonds you have are real and strong.
...
And remember — You go me too. Always here, always rooting for you.`,
    ...
    },
    {
      ...
      subtitle: "This will help",
      icon: "laugh",
      quote: "A smile is the prettiest thing you can wear. And yours is absolutely stunning.",
      message: `Think about the last time you laughed so hard your stomach hurt. Remember that feeling?

Watch your favorite show. Eat your favorite snack. Dance in your room. Do whatever makes your soul happy.
...
And if none of that works... just know that someone out there is thinking of you right now and smiling because you exist.`,
  ...
  secretChapter: {
    ...
    message: `I couldn't fit everything into the main sections. There are some things that are just for us — moments too precious, feelings too deep, memories too sacred to share in the open.
...
nah. Happy Vinishaaaaa day.`,
  ...
  // =========================================================================
  finalSurprise: {
    lockedMessage: "Something Special Is Waiting...",
    clickMessage: "Click to Reveal",
    unlockedTitle: "Happy Birthday!",
    message: `Surprise! I wanted to save something extra special for today. This moment — right now — is all about celebrating YOU.

You've made it through another incredible year. You've grown, you've learned, you've loved. And I feel so lucky to have been part of it.
